...
export class ProductReviewController {
    ...
    async createReview(@Param("productId", ParseUUIDPipe) productId : string, @GetUser("id") buyerId : string, @Body() dto : CreateProductReviewDto) {
        const review = await this.reviewService.createReview(productId, buyerId, dto)
